...
<template>
  <div class="">
    <div class="flex flex-wrap gap-6">
        <div v-for="job in data.slice(0, 15)" :key="job.id" class="bg-white rounded-2xl shadow-lg hover:shadow-2xl w-65 overflow-hidden hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
